...
<form action="{{'/update-data/'.$editData->id}}" method="post">
 ...
 <div class="form-group">
    ...
    <input type="text" name="name"class="form-control" id="exampleInputPassword1" value="{{ $editData->name }}"placeholder="Name">
    @error('name')
  ...
  <div class="form-group">
    ...
    <input type="text" name="email"class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{ $editData->email }}" placeholder="Enter email">
    @error('email')
    <span class="text-danger">{{ $message }}</span>
    @enderror
